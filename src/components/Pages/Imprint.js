                            ...
                            <div className="">
                                <div className="content" role="article">
                                    ...
                                    ? <div id="imprint" className="py-3">
                                        <h2 className="heading">Impressum</h2>
                                        <div className="row">
                                            <div className="col-12 col-sm-6 py-3">
                                                ...
                                                <p>
                                                Herausgegeben im Auftrag des Rektors der RWTH Aachen University.
                                                </p>
                                                <p>
                                            ...
                                            <div className="col-12 col-sm-6 py-3">
                                                ...
                                                <p>
                                                Für die Richtigkeit und Aktualität der Inhalte sind die jeweiligen Ersteller der einzelnen Seiten verantwortlich.
                                                </p>
                                                <p>
                                                Ansprechpartner: <a href="http://www.metallurgie.rwth-aachen.de/new/src/index2.php?route=team_detail_sql&amp;teamid=29">Prof. Dr. Ing. Dr. h.c. Bernd Friedrich</a><br/> Tel: +49 241 80 95850<br/> E-mail: <a href="mailto:institut@ime-aachen.de">institut@ime-aachen.de</a>
                                                </p>
                                                <p>
                                                Details zu Fragen der Haftung und des Datenschutzes sind im Disclaimer nachzulesen.
                                                </p>
                                ...
                                ? <div id="" className="row pb-4">
                                    <div id="liability" className="py-3 col-12 col-sm-6">
                                        ...
                                        <p>
                                        F&uuml;r die Richtigkeit und Aktualit&auml;t der Inhalte ist der Herausgeber verantwortlich. Die Seiten werden unter Koordinierung der Web-Master gestaltet, eingestellt und aktualisiert. <br/><a href="http://www9.rwth-aachen.de/go/id/lwb/">Disclaimer und Datenschutzerklärung</a>
                                        </p>
                                    </div>
...
export default withLangSwitchListener(Imprint);